...
(the other case is degenerate) and use induction on the actual integer
...
I tidied it quite considerably in the course of writing this blog post, but the new version
