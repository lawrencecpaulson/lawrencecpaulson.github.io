...
usemathjax: true 
tags: [logic, Bertrand Russell, constructive logic, Martin-Löf type theory, law of excluded middle, philosophy]
---
...
and [Kőnig's infinity lemma](https://en.wikipedia.org/wiki/Kőnig's_lemma)
