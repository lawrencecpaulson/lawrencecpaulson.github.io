...
Also included, largely material borrowed from Isabelle/ZF: ordinal exponentiation and [Cantor normal form](https://jdh.hamkins.org/tag/cantor-normal-form/), cardinals and cardinal arithmetic, $\aleph$-notation for cardinals, transfinite induction and recursion, order types and many other odds and ends.
...
Filling all these gaps in the libraries seemed to involve more effort (and space in the [theory file](https://isa-afp.org/entries/Wetzels_Problem.html)) than the Wetzel problem itself. 
