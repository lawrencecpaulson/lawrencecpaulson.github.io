...
refinement of possibly nonterminating transition systems. Our proof can be found in the 
[AFP](https://isa-afp.org/thys/Ordered_Resolution_Prover/Lazy_List_Chain.html). 
On the plus side, Isabelle conveniently
