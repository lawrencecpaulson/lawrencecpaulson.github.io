...
usemathjax: true 
tags: [set theory, type theory, axiom of choice, Ernst Zermelo, Archive of Formal Proofs, higher-order logic, Lean]
---
...
Here's another answer to my question: ZF set theory turns out to be surprisingly close in strength to the calculus of inductive constructions (CIC), the type theory implemented by Rocq and Lean.
