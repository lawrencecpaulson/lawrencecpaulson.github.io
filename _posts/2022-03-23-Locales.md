...
Let's look at a [new formalisation](https://isa-afp.org/entries/Jacobson_Basic_Algebra.html) of abstract algebra, following a [classic text](https://store.doverpublications.com/0486471896.html)
...
There is much, much more in the [full group theory development](https://isa-afp.org/browser_info/current/AFP/Jacobson_Basic_Algebra/Group_Theory.html).
