...
usemathjax: true 
tags: [examples, recursion, Isabelle, Fibonacci, newbies, sledgehammer]
---
...
To run this example yourself, you need to install [Isabelle](https://isabelle.in.tum.de/) (it's easy!) and perhaps read some [introductory documentation](https://isabelle.in.tum.de/dist/Isabelle/doc/prog-prove.pdf). The file containing this example can be [downloaded](/Isabelle-Examples/Fibonacci.thy).
