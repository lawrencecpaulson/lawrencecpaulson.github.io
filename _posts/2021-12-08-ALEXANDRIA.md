...
usemathjax: true 
tags: [general, ALEXANDRIA, Isabelle, Archive of Formal Proofs, Mizar, HOL system, HOL Light, Coq, Lean]
---
...
2. [Combinatorial Design Theory](https://isa-afp.org/entries/Design_Theory.html), apparently the first formalisation of block designs, due to Chelsea Edmunds, one of my PhD students
3. [Grothendieck's Schemes in Algebraic Geometry](https://isa-afp.org/entries/Grothendieck_Schemes.html) answers the challenge set by the Lean community to formalise those objects
